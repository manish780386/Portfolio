...
const STATIC_PLATFORMS = [
  { name: "HackerRank",    handle: "@dangemanish35", solved: 97,  note: "3★ Python · PS · SQL",     url: "https://www.hackerrank.com/profile/dangemanish35",       color: "#22c55e", glow: "#22c55e", icon: "🏅" },
  { name: "CodeChef",      handle: "@dange_123",     solved: 90,  note: "Rookie League · Growing",  url: "https://www.codechef.com/users/dange_123",               color: "#f97316", glow: "#f97316", icon: "👨‍🍳" },
